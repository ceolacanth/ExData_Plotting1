...
plot( household$Voltage ~ household$DateTime, type="l" , ylab = "Voltage", xlab="")
...
legend('topright',c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col=c('black','red','blue'), lwd=c(.5,.5))
plot( household$Global_reactive_power ~ household$DateTime, type="l", col="black", xlab="" )
dev.off()